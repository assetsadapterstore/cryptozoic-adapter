...
func (this *WalletManager) GetErc20TokenEvent(transactionID string) (*ethereum.TransferEvent, error) {
...
func (this *VCCBlockScanner) UpdateTxByReceipt(tx *ethereum.BlockTransaction) (*ethereum.TransferEvent, error) {
	//过滤掉未打包交易
